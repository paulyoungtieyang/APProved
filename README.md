...
This is **Prototype 2**, branched from `prototype-1-ucla-version` (tagged
[`v1.0`](../../releases/tag/v1.0) — the frozen UCLA Anderson EMBA course
submission). This branch is scoped to just the code and the demo — no
course write-ups or presentation assets — and is where active development
continues from here.
...
`https://htmlpreview.github.io/?https://github.com/paulyoungtieyang/APProved/blob/prototype-2/demo/APProved_Clickable_Demo.html`.
